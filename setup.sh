...
if n < 4:
    print(f"  WARNING: found {n} GPU(s). Scripts gpu0-gpu3 each need their own GPU.")
...
echo "  nohup bash run_gpu2.sh > logs/gpu2.log 2>&1 &   # n=10"
echo "  nohup bash run_gpu3.sh > logs/gpu3.log 2>&1 &   # n=20"
echo "  nohup bash run_gpu4.sh > logs/gpu4.log 2>&1 &   # n=100"
echo ""
